...
<div class="container-fluid p-0">
      ...
      <div class="container my-5">
        <form id="cards_form" action="scripts/product_deletion.php" method="post">
        <div class="row gy-3">
          <?php
          $DB = new Database();
          ...
          <div class="col-6 col-md-3">
            <div class="card h-100 border border-dark">
              ...
              <label class="form-check-label">
                <input form="cards_form" class="delete-checkbox form-check-input border border-dark mt-3" type="checkbox" name="sku[]" value="<?php echo $product->sku; ?>">
              </label>
              </div>
