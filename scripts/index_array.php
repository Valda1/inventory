            ...
            <div class="card border border-dark">
              ...
              <label class="form-check-label">
                ...
                <div class="card-body text-center">
                      ...
                      <h6 class="card-text"><?php if(!empty($product['height_cm']) && !empty($product['length_cm']) && !empty($product['width_cm'])){ echo "Dimentions: " . $product['height_cm'] . "x" . $product['length_cm'] . "x" . $product['width_cm'];}; ?>
                </div>
            </div>
          </div>
            <?php } ?>
